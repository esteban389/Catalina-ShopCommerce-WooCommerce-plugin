<?php
/**
 * Admin Management Page for ShopCommerce Product Sync
 *
 * This file contains all the management page logic for the admin interface.
 * Separated from the main plugin file for better organization.
 *
 * @package ShopCommerceProductSync
 */
...
/**
 * Register the management page in the admin menu
 */
function shopcommerce_register_management_page() {
    add_management_page(
...
add_action('admin_menu', 'shopcommerce_register_management_page');